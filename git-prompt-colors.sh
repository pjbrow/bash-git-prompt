...
GIT_PROMPT_PREFIX="${Magenta}("                 # start of the git info string
GIT_PROMPT_SUFFIX="${Magenta})"                 # the end of the git info string
GIT_PROMPT_SEPARATOR="${Magenta}|"              # separates each item
